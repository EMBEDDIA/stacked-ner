...
#from modules.tokenizer import CamembertTokenizer
from transformers import CamembertTokenizer

from transformers import CamembertForTokenClassification


class CamembertEmbedding(ContextualEmbedding):
    ...
    def __init__(self, vocab: Vocabulary, model_dir_or_name: str = 'en', layers: str = '-1',
        ...
        self.model = _CamembertWordModel(model_dir_or_name=model_dir_or_name, vocab=vocab, layers=layers,
...
class _CamembertWordModel(nn.Module):
...
class CamembertWordPieceEncoder(nn.Module):
